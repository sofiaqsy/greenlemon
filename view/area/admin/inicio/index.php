...
<div class="col-md-8">
	<div class="panel panel-default">
	  ...
	  <ul class="list-group">
	    <li class="list-group-item"><?php echo $this->Attach['vistas'][0]['Nombre'];?><span class="badge pull-right"><?php echo $this->Attach['vistas'][0]['Lectura'];?></span></li>
	    <li class="list-group-item"><?php echo $this->Attach['vistas'][1]['Nombre'];?> <span class="badge pull-right"><?php echo $this->Attach['vistas'][1]['Lectura'];?></span></li>
	  </ul>
	</div>
</div>
